...
\begin{proposition}
Soit $\varphi$ une coloration de $C$, $i$ et $j$ deux couleurs pésentes dans $R$ et $m = (e,f)$ un couplage de $M$ tel que les arêtes de $m$ sont coloriées avec $i$ ou $j$. Alors, $\varphi$ \emph{se réduit} vers une autre coloration $\varphi'$ si pour 
